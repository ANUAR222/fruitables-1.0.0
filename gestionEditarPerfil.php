...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_update_datos_pago = "UPDATE datospago SET Domicilio = ?, Número_tarjeta = ?, Teléfono = ? WHERE id = (SELECT id_datosPago FROM cliente WHERE id_usuario = ?)";
    ...
    $stmt_update_datos_pago->bind_param("sssi", $domicilio, $num_tarjeta, $telefono, $id);
