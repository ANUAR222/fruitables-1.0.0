        ...
        <div class="container-fluid fixed-top">
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    <a href="indexAdmin.php" class="navbar-brand"><h1 class="text-primary display-6">SaberComer</h1></a>
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="mensajesAdmin.php" class="nav-item nav-link">Mensajes</a>
                        ...
                        <div class="d-flex m-3 me-0">
                            ...
                            <a href="Stock.php" class="position-relative me-4 my-auto">
